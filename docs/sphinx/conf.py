...
.. |cthreepo_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('cthreepo')
...
man_pages = [
    (master_doc, 'cthreepo', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/cthreepo'
